...
export default function TasteProfileCards({ wine }) {
  ...
  return (
    <section className="flex w-full items-center justify-center">
      <div className="grid w-full max-w-[1440px] auto-rows-min grid-cols-1 justify-items-center gap-x-10 gap-y-12 px-4 pt-10 sm:gap-x-14 sm:px-20 sm:pt-12 md:grid-cols-1 lg:grid-cols-3">
        <TasteCard
