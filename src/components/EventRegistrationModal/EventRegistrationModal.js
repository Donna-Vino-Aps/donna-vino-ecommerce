            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                <input
                  ...
                  required
                  className="w-[49%] border border-tertiary2-normal rounded p-2 text-bodyLarge"
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between w-full">
                <div className="flex w-full gap-2 mb-4 md:mb-0">
                  <button
                    type="button"
                  ...
                  <button
                    type="submit"
                    className="flex-1 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded font-medium disabled:bg-blue-500 disabled:hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
