            ...
            >
              <div className="mb-4 min-h-[20rem] w-full items-center md:relative md:mb-0 md:w-[50%]">
                {slide.type === "video" ? (
                  hasCredits ? (
                    <video
                      className="mt-4 min-h-[22.5rem] w-full rounded-br-[0rem] rounded-tr-[0rem] object-cover md:absolute md:inset-0 md:mt-0 md:min-h-[43.75rem] md:rounded-br-xl md:rounded-tr-[8rem]"
                      autoPlay
                      loop
                      muted
                      role="region"
