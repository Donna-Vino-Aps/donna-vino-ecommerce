...
const FaqItem = ({ question, answer }) => {
  ...
  return (
    <div
      className={`mx-auto mb-3 flex cursor-pointer flex-col rounded-lg border border-solid border-[#D9D9D9] ${isOpen ? "bg-transparent" : "bg-tertiary2-normal"} w-[18.5rem] md:w-[42.125rem] lg:w-[48.125rem]`}
