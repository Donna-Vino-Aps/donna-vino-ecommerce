...
const SearchBar = () => {
  ...
  return (
    <div className="flex justify-center">
      <div
        className={`relative flex items-center justify-between rounded-lg border border-tertiary1-light focus:outline-none md:mx-4 ${isMobile ? "h-auto w-[21.50rem]" : "h-[5.625rem] w-full"}`}
      >
        {!isMobile && <SortBy />}
        {!isMobile && <SearchIcon />}
        {isMobile && <SearchIcon />}
