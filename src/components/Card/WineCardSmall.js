...
const WineCardSmall = ({
  ...
  return (
    <section
      ...
      className="group relative w-[270px] min-h-[411px] cursor-pointer bg-white shadow-xl rounded-lg overflow-hidden transition-transform duration-300 hover:scale-105 flex flex-col"
    >
      ...
      {isNew && (
        <span className="absolute right-2 top-2 flex items-center gap-1 rounded bg-primary-normal px-2 py-1 text-xs text-white font-medium">
          New
          <img
